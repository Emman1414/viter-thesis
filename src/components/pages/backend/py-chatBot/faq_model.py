...
# Define model path
MODEL_PATH = "src/components/pages/backend/chatbotModels/fine_tuned_sbert"
...
# Load FAQ dataset
faq_df = pd.read_csv("src/components/pages/backend/chatbotModels/faq_dataset.csv")  # Ensure this file is available
